 ...
 */
 ...
 //onEditProfessor, - not implemented

 const ProfessorEdit = ({ courses, programs, oldFirstName, oldLastName, oldTeachLoad, oldTimeBlock, oldCanTeach, oldWantTeach}) => {
  ...
  const [teach_load, setTeachLoad] = useState(oldTeachLoad);
  const [time_block, setTimeBlock] = useState(oldTimeBlock);
  const [can_teach, setCanTeach] = useState(oldCanTeach);
  const [want_teach, setWantTeach] = useState(oldWantTeach);
...
}//<input type="submit" value='Save Edits' className='btn btn-block'/> - removed button to avoid unknown errors
   ...
   return (
     <div className="home">
       <div className='element-page'>
         {profEditedId === null ? <ProfessorAdd onAddProfessor={onAddProfessor} courses={courses} programs={programs}/> 
         : <ProfessorEdit courses={courses} programs={programs} oldFirstName={editedProfessor.firstName} oldLastName={editedProfessor.lastName} 
         oldTeachLoad={editedProfessor.teach_load} oldTimeBlock={editedProfessor.time_block} 
         oldCanTeach={editedProfessor.can_teach} oldWantTeach={editedProfessor.want_teach}/>
         }
